#ifndef EDUCATIVEMODERNCPPCONCUR_DOTPRODUCTASYNC_H
#define EDUCATIVEMODERNCPPCONCUR_DOTPRODUCTASYNC_H
#include <iostream>
#include <future>
#include <random>
#include <vector>
#include <numeric>
namespace DotProductAsync
{
    using namespace std;
...
#endif //EDUCATIVEMODERNCPPCONCUR_DOTPRODUCTASYNC_H
