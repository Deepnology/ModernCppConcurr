#ifndef EDUCATIVEMODERNCPPCONCUR_ATOMICMEMMODELCASE1_H
#define EDUCATIVEMODERNCPPCONCUR_ATOMICMEMMODELCASE1_H
#include <atomic>
#include <iostream>
#include <thread>
...
#endif //EDUCATIVEMODERNCPPCONCUR_ATOMICMEMMODELCASE1_H
